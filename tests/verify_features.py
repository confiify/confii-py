#!/usr/bin/env python3
"""
End-to-end feature verification for confii.
...
def make_tmp():
    ...
    return tempfile.mkdtemp(prefix="confii_verify_")
...
def test_multi_source_merge():
    ...
    try:
        ...
        from confii import Config
        from confii.loaders import JsonLoader, YamlLoader
...
def test_config_diff():
    from confii.config_diff import ConfigDiffer, DiffType
...
def test_secret_resolution():
    ...
    try:
        ...
        from confii import Config
        from confii.loaders import YamlLoader
        from confii.secret_stores.providers.dict_secret_store import (
            DictSecretStore,
        )
...
def test_pydantic_validation():
    ...
    from confii.validators.pydantic_validator import PydanticValidator
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("confii END-TO-END Feature Verification")
    print("=" * 60)
    print()
