...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🚀 Confii Development Container - Post-Create Setup"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
while [ $retry_count -lt $max_retries ]; do
    if curl -sf http://localhost:4566/_localstack/health >/dev/null 2>&1; then
        ...
        aws --endpoint-url=http://localhost:4566 s3 mb s3://confii-test 2>/dev/null || true
        aws --endpoint-url=http://localhost:4566 s3 mb s3://confii-prod 2>/dev/null || true
...
api:
  ...
  timeout: 30
EOFCONFIG
        aws --endpoint-url=http://localhost:4566 s3 cp /tmp/test-config.yaml s3://confii-test/config.yaml 2>/dev/null || true
        ...
        print_info "  S3 buckets: confii-test, confii-prod"
...
echo "  typecheck          - mypy src/confii"
echo ""
echo "📖 Documentation:"
