...
- `src/confii/secret_stores/vault_auth/__init__.py`
- `src/confii/secret_stores/vault_auth/base.py`
- `src/confii/secret_stores/vault_auth/token.py`
- `src/confii/secret_stores/vault_auth/approle.py`
- `src/confii/secret_stores/vault_auth/oidc.py` ⭐ (OIDC + Kerberos)
- `src/confii/secret_stores/vault_auth/jwt.py`
- `src/confii/secret_stores/vault_auth/ldap.py` ⭐ (PIN + Token support)
- `src/confii/secret_stores/vault_auth/kubernetes.py`
- `src/confii/secret_stores/vault_auth/aws.py`
- `src/confii/secret_stores/vault_auth/azure.py`
- `src/confii/secret_stores/vault_auth/gcp.py`
...
**Modified:**
- `src/confii/secret_stores/providers/hashicorp_vault.py` - Added `auth_method` parameter
...
from confii.secret_stores import SecretResolver
