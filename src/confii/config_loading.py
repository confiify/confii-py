...
from confii.enhanced_source_tracker import SourceInfo
...
class ConfigLoading:
    ...
    def _load_configs_with_tracking(
        ...
        result = []
        for config, source_file, loader_type, _loader in configs:
    ...
    def _track_env_config(self) -> None:
        ...
        for key in list(self.enhanced_source_tracker.sources.keys()):
            if key.startswith(env_prefix):
                ...
                if (
                    key in self.enhanced_source_tracker.override_history
                    and unprefixed_key
    ...
    def _generate_ide_support(self) -> None:
        ...
        try:
            from confii.ide_support import IDESupport
            ...
            if self.ide_stub_path is None:
                ...
                with open(init_path, "w") as f:
                    f.write("# Auto-generated by Confii for IDE support\n")
