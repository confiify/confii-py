"""Configuration composition system for Confii.
...
class ConfigComposer:
    ...
    def _load_include(self, file_path: str, depth: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            if ext in (".yaml", ".yml"):
                ...
                from confii.utils.toml_compat import load_file as toml_load_file
    ...
    def _merge_dicts(self, base: Dict[str, Any], new: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        from confii.utils.dict_utils import deep_merge_dicts
