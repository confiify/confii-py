"""IDE autocomplete support for Confii."""
...
class IDESupport:
    ...
    def _generate_stub_content(config_dict: Dict[str, Any], module_name: str) -> str:
        ...
        stub_lines.append("# from confii import Config")
...
class VSCodeSupport:
    ...
    Confii type stubs are picked up automatically by Pylance and
    mypy within VS Code.
