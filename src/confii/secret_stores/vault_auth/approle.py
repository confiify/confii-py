...
class AppRoleAuth(VaultAuthMethod):
    ...
    Example:
        >>> from confii.secret_stores.vault_auth import AppRoleAuth
        >>> from confii.secret_stores import HashiCorpVault
        >>>
        >>> auth = AppRoleAuth(role_id="your-role-id", secret_id="your-secret-id")
    ...
    def __init__(
        ...
        Example:
            >>> auth = AppRoleAuth(role_id="abc-123", secret_id="xyz-789")
        """
