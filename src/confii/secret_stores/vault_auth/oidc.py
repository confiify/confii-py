...
from confii.secret_stores.vault_auth.base import (
...
class OIDCAuth(VaultAuthMethod):
    ...
    Example:
        ...
        >>>
        >>> auth = OIDCAuth(role="myapp-role", credential_provider=get_credentials)
    """
    ...
    def __init__(
        ...
        Example:
            ...
            >>>
            >>> auth = OIDCAuth(role="myapp", credential_provider=pin_token_auth)
        """
        self.role = role
    ...
    def authenticate(self, client: Any) -> str:
        ...
        raise VaultAuthenticationError(
            f"OIDC authentication failed. Attempted methods: {', '.join(errors)}"
        )
...
class KerberosAuth(VaultAuthMethod):
    ...
    Example:
        >>> from confii.secret_stores.vault_auth import KerberosAuth
        >>> from confii.secret_stores import HashiCorpVault
        >>>
