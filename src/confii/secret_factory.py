...
from confii.source_factory import _expand_env_vars
...
def _create_vault_auth(auth_dict: Dict[str, Any]) -> Any:
    ...
    Raises:
        ConfiiError: If the method is unknown or required parameters are
            missing.
    """
...
def _create_secret_store(config_dict: Dict[str, Any]) -> SecretStore:
    ...
    Raises:
        ConfiiError: If the provider is unknown or required parameters
            are missing.
    """
...
def create_secret_resolver_from_config(
    ...
    * ``prefix`` (str | None, default ``None``)
    ...
    Raises:
        ConfiiError: If required configuration is missing or invalid.
    """
