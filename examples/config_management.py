...
from confii.loaders import EnvironmentLoader, JsonLoader, YamlLoader
...
def dry_run_reload() -> None:
    ...
    try:
        ...
        # Dry-run: Confii loads the new values but does NOT apply them
...
def main() -> None:
    ...
    print("=" * 70)
    print("  Confii — Config Management Examples")
    print("=" * 70)
