"""Comprehensive example of secret store integration with Confii.
...
def example_custom_secret_store():
    ...
    from confii.secret_stores.base import SecretNotFoundError, SecretStore
...
def main():
    """Run all examples."""
    print("\n" + "=" * 60)
    print("Confii Secret Store Integration Examples")
    print("=" * 60)
