#!/usr/bin/env python3
"""Loader Showcase — demonstrates every config file format supported by Confii."""
...
def example_http_remote_loading() -> None:
    ...
    print("Usage pattern:\n")
    print("    from confii.loaders import HTTPLoader\n")
...
def example_ssm_loader() -> None:
    ...
    print("Usage pattern:\n")
    print("    from confii.loaders import SSMLoader\n")
