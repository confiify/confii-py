...
Usage:
    from confii.secret_stores import HashiCorpVault
    from confii.secret_stores.vault_auth import KubernetesAuth
...
Usage:
    from confii.secret_stores import HashiCorpVault
    from confii.secret_stores.vault_auth import AWSAuth
...
Usage:
    from confii.secret_stores import HashiCorpVault
    from confii.secret_stores.vault_auth import JWTAuth
    import os
...
def example_complete_workflow():
    ...
    print(
        """
Complete example integrating Vault auth with Confii.
