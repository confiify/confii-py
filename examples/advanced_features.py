#!/usr/bin/env python3
"""Advanced features showcase for Confii.

This example demonstrates the new features that make Confii
...
from confii.exporters import add_export_methods
from confii.validators import PydanticValidator, SchemaValidator

# Optional imports for advanced features
try:
    from confii.validators.pydantic_validator import AppConfig, DatabaseConfig
...
try:
    from confii.loaders.remote_loader import GitLoader, HTTPLoader, S3Loader
...
def main():
    """Run all examples."""
    print("🚀 Confii Advanced Features Demo")
    print("=" * 60)
...
These features make Confii production-ready and competitive
